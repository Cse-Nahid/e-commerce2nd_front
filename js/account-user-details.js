document.addEventListener('DOMContentLoaded', function () {
    ...
    const profileUrl = accountType === 'seller' ? 'https://drf-2nd-ecommerce-backend.vercel.app/dashboard/profile/seller/' : 'https://drf-2nd-ecommerce-backend.vercel.app/dashboard/profile/customer/';
    const purchasesUrl = 'https://drf-2nd-ecommerce-backend.vercel.app/dashboard/customer/purchases/';
    const productsUrl = 'https://drf-2nd-ecommerce-backend.vercel.app/dashboard/seller/products/';
    const categoriesUrl = 'https://drf-2nd-ecommerce-backend.vercel.app/categories/categories/';
    const addProductUrl = 'https://drf-2nd-ecommerce-backend.vercel.app/dashboard/seller/products/';
    ...
    function deleteProduct(productId) {
        fetch(`https://drf-2nd-ecommerce-backend.vercel.app/dashboard/seller/products/${productId}/`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Token ${token}`,
                'Content-Type': 'application/json'

...
async function fetchProducts() {
    try {
        const response = await fetch('https://drf-2nd-ecommerce-backend.vercel.app/products/products/');
...
function addToCart(productId) {
    ...
    fetch(`https://drf-2nd-ecommerce-backend.vercel.app/products/cart/add/${productId}/`, {
        method: 'POST',
        headers: {
...
async function fetchFilteredProducts(searchTerm = '', categoryName = '') {
    let apiUrl = 'https://drf-2nd-ecommerce-backend.vercel.app/products/products/';
...
async function fetchCategories() {
    try {
        const response = await fetch('https://drf-2nd-ecommerce-backend.vercel.app/categories/categories/');
